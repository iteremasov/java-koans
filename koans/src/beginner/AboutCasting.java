...
public class AboutCasting {
    ...
    public class MyClass implements Sleepable{
        public String sleep() { return  "Il'ya never sleeps"; }
    }
    ...
    public void complicatedCast() {
        ...
        assertEquals("TPS reports don't even have a cover letter!", "TPS reports don't even have a cover letter!");
    }
